                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    @endif
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            @if(!$item->sold)
                                            <a href="{{route('item.edit', $item)}}" class="text-indigo-600 hover:text-indigo-900">Edit</a><br />
                                            <a href="{{route('item.markassold', $item)}}" class="text-indigo-600 hover:text-indigo-900">Mark as sold</a>
                                            @endif
                                        </td>
                                    </tr>
                                        @empty
